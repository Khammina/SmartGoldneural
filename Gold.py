...
try:
    ...
    raise ImportError("MetaTrader5 is required but could not be imported. Please check your installation.")
...
try:
    ...
    raise ImportError("TensorFlow is required but could not be imported. Please check your installation.")
